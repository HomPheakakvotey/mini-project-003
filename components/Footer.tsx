...
export default function Footer() {
  ...
  return (
    <footer className="mx-auto container xl:px-20 lg:px-12 sm:px-6 px-4 py-12">
      <div className="flex flex-col items-center justify-center">
        ...
        <div className="flex items-center mt-6">
          <p className="text-base leading-4 text-gray-800">
            2023 <span className="font-semibold">Amore</span>
          </p>
          <div className="border-l border-gray-800 pl-2 ml-2 mb-1">
            <p className="text-base leading-4 text-gray-800">
